...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login(LoginUserCommandRequest loginUserCommandRequest)
        {
            ...
            Response.Cookies.Append("X-Access-Token", response.Token.AccessToken, new CookieOptions() { HttpOnly = true, });
            Response.Cookies.Append("X-Refresh-Token", response.Token.RefreshToken, new CookieOptions() { HttpOnly = true,  });
            return Ok(response);
        }
